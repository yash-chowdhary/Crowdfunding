...
class EditProjectDetailsPage extends Component {
    ...
    deleteProject = (details) => {
        axios.delete(`http://localhost:3003/project/${details.username}/${details.orgname}/${details.teamname}/${details.projname}`)
            .then(response => {
    ...
    editProject = () => {
        ...
        axios.post('http://localhost:3003/editProject', postData)
            .then(response => {
                console.log('updated!');
